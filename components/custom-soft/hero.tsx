...
const HeroCustomSoft = () => {
  const t = useTranslations('ServicePages.customSoftware.Hero');
  ...
  />
      ...
      <div className=' w-full pt-40 md:pt-[22vh] pb-10 md:pb-14  flex flex-col justify-center items-center top-0 left-0 font-manrope space-y-4  '>
            ...
            <h1 className='text-4xl lg:text-5xl 2xl:text-5xl  tracking-wide bg-clip-text text-transparent bg-radial from-[#ffffff70] to-[#999fb2] text-center leading-tight max-w-3xl z-10' style={{fontFamily: "'Syne', sans-serif"}}>
                {t('titlePart1')}<span className='bg-radial bg-clip-text text-transparent from-[#ffffff] to-[#999fb2]'>{t('titlePart2')}</span> {t('titlePart3')} <span className='bg-radial bg-clip-text text-transparent from-[#ffffff] to-[#999fb2]'>{t('titlePart4')}</span> <span className='bg-radial bg-clip-text text-transparent from-[#ffffff] to-[#999fb2]'>{t('titlePart5')}</span>
            </h1>
