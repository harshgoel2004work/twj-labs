...
const OtherServicesPricing = () => {
  ...
  return (
    <section className="w-full px-6 py-20 md:py-32 flex flex-col gap-12 items-center bg-gradient-to-b from-[#f8f9ff] to-[#eef1ff] text-slate-900 font-manrope relative overflow-hidden">
      ...
      <div className="flex flex-col gap-6 w-full max-w-5xl relative z-10">
        {otherPricingPlans.map((service, index) => (
          <div
            key={index}
            className="group relative p-6 md:p-8 rounded-2xl bg-white border border-slate-200 shadow-sm hover:shadow-xl hover:border-indigo-200 transition-all duration-300 w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center"
          >
            {/* Left Side: Info & Price */}
            <div className="lg:col-span-5 flex flex-col gap-4 border-b lg:border-b-0 lg:border-r border-slate-100 pb-6 lg:pb-0 lg:pr-8">
              <div>
            ...
            <div className="lg:col-span-7">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3 text-sm text-slate-600">
