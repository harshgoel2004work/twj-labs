...
const GenericHeroPage = ({ data }: { data: HeroSection }) => {
  ...
  return (
    ...
    <div>
      ...
      <div className="w-full min-h-screen font-manrope relative text-white z-0  pt-28 lg:pt-32 max-w-7xl mx-auto lg:pb-6 flex flex-col justify-center px-6 md:px-0">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2  gap-12 lg:gap-10 h-full">
          ...
          <div className="w-full flex flex-col items-center md:items-start justify-between font-manrope space-y-4 lg:space-y-12 order-1 ">
            ...
            <div className="flex flex-col items-center md:items-start gap-5">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-[48px] 2xl:text-[56px] tracking-wide bg-clip-text text-transparent bg-radial from-[#ffffff70] to-[#999fb2] leading-[1.2] md:leading-tight max-w-full lg:max-w-xl z-10 text-center md:text-left" style={{ fontFamily: "'Syne',sans-serif" }}>
                {data.title}
              </h1>
            </div>
          ...
          >
            ...
            <motion.div
              className="w-full h-full relative rounded-3xl bg-radial from-[#06060a60] via-[#16161660] to-[#0b0b1260] backdrop-blur-lg overflow-hidden flex flex-col items-center justify-center p-6 space-y-8 z-1 transition-transform duration-150 ease-out will-change-transform border border-white/5"
              style={{
