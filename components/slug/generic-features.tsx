...
const GenericFeaturesSection = ({ slug, title }: { slug: string, title: string }) => {
  ...
  return (
    <div className="w-full font-manrope relative text-white z-0 max-w-7xl mx-auto pt-24 2xl:pt-30 pb-8 overflow-hidden px-6 md:px-0">
      <div className="w-full h-full py-14">
        <div className="flex flex-col md:items-start items-center gap-4 mb-16">
          <CustomBadge title={'Services'} darkMode={true} />
          {/* ── headline ── */}
          <h2 className=" text-[clamp(2rem,5vw,3.5rem)] leading-[1.12] tracking-tight mb-4 mt-5">
            <span className="text-white">{title}</span>

          </h2>

          {/* ── sub ── */}
          <p className=" text-[14.5px] leading-relaxed text-white/40 max-w-md mb-9">
