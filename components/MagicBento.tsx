...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    ...
    label: '',
    viewItem:{
      className: 'z-10 absolute left-1/2 -translate-x-1/2 translate-y-6 overflow-hidden  three-d-card-2  opacity-50 w-[80%] aspect-[100%]',
      item: <Image src="/hero/1-new.png" alt="Webflow Development" width={1000} height={1000} className='w-full h-full'/>
    }
  },
  {
    color: '#0b0a0f',
          ...
          {cardData.map((card, index) => {
            ...
            return (
              ...
              >
                ...
                {card.viewItem && (
                  <div className={card.viewItem.className || ''}>
                    {card.viewItem.item}
                  </div>
                )}

                <div className="card__header flex justify-between gap-3 relative text-white z-[3]">
                  <span className="card__label text-base">{card.label}</span>
                </div>
                <div className="card__content flex flex-col relative text-white z-[3]">
                  <h3 className={`card__title font-normal text-base m-0 mb-1 ${textAutoHide ? 'text-clamp-1' : ''}`}>
                    {card.title}
                  </h3>
                  <p className={`card__description text-xs leading-5 opacity-90 z-[3] ${textAutoHide ? 'text-clamp-2' : ''}`}>
                    {card.description}
                  </p>
                </div>
              </div>
